...
import { DIHeaderNew } from "willdan-ui/dist";
import {
  ComponentsState,
...
export const layout: Partial<ComponentsState> = {
  ...
  MenuContainer: ({ children }) => {
    ...
    return (
      <header>
        <header style={{ maxWidth: "1100px", margin: "10px auto 10px auto" }}>
          <DIHeaderNew
            defaultTheme="light"
            email="jsifuentes@willdan.com"
            title="Piral Multitenant POC"
            isBackButtonVisible={false}
            isFilterMenuVisible={false}
            isDrawerToggleVisible={false}
            softwareVersion="1.0.0"
            listOptions={[
              {
                __typename: "HeaderListOption",
                id: "one",
                name: "First option",
              },
              {
